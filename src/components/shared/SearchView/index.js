...
class Page extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      searchArea: searchStore.search.area,
      searchPeople: searchStore.search.people,
      searchStartDate: searchStore.search.startDate,
      searchEndDate: searchStore.search.endDate,
      peopleBtns: [
        { txt: '1명', },
        { txt: '2명', },
        { txt: '3명', },
